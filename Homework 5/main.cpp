...
protected:
    ...
    void drawFilledRectangle(int height, int width) const
    {
...
public:
    ...
    void draw() const override
    {
        ...
        //новый метод для рисования квадрата
        drawFilledRectangle(static_cast<int>(side), static_cast<int>(side));
    }
};
...
public:
    ...
    void draw() const override
    {
        ...
        //новый метод для рисования прямоугольника
        drawFilledRectangle(static_cast<int>(height), static_cast<int>(width));
    }
};
...
//новый класс-обёртка для ShapeFactory
class ShapeFactoryWrapper
{
public:
    class ShapeFactory
    {
...
int main()
{
    ...
    {
        shapes[i] = ShapeFactoryWrapper::ShapeFactory::createRandomShape();
    }
